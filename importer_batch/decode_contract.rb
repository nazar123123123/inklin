...
tx = Transaction.find_by(:to => "0xf230b790e05390fc8295f4d3f60332c93bed42e2")

#TokenContract = web3.eth.contract(tokenInterface)
#tokenInstance = TokenContract.at(tx.to)
#puts(tokenInstance._to())

web3.abi.decodeParameters(tokenInterface, tx.data)
